...
class Edit extends \Plazathemes\Bannerslider\Controller\Adminhtml\Banner {
    ...
    public function execute()
    {
		...
		if($model->getId())
			$resultPage->getConfig()->getTitle()->prepend($model->getTitle() ? $model->getId() : __('Edit Banner'));
		else
